    ...
    <div>
      ...
      <Card>
        ...
        <div style={{ marginBottom:14 }}>
          <label style={{ display:'block', marginBottom:6, fontSize:'0.58rem', color:'var(--txt-muted)', letterSpacing:'.1em', textTransform:'uppercase', fontFamily:"'DM Mono',monospace" }}>
        ...
        <div style={{ borderTop:'1px solid var(--brd)', paddingTop:14 }}>
          <div style={{ display:'flex', alignItems:'center', gap:6, marginBottom:10 }}>
            ...
            <span style={{ fontSize:'0.58rem', color:'var(--txt-muted)', letterSpacing:'.1em', textTransform:'uppercase', fontFamily:"'DM Mono',monospace" }}>Consultas rápidas</span>
          </div>
          <div style={{ display:'flex', gap:6, flexWrap:'wrap' }}>
            {QUICK.map(q => (
              <button key={q.label} onClick={() => setSql(q.sql)}
                style={{ padding:'4px 10px', borderRadius:4, border:'1px solid var(--brd)', background:'var(--bg-raised)', color:'var(--txt-secondary)', fontSize:'0.68rem', cursor:'pointer', fontFamily:"'DM Sans',monospace", transition:'all .12s' }}
        ...
        {error && (
          <div style={{ marginTop:14, padding:'10px 14px', background:'var(--danger-dim)', border:'1px solid var(--danger-brd)', borderRadius:6, color:'var(--danger)', fontSize:'0.76rem', fontFamily:"'DM Mono',monospace" }}>
            Error: {error}
          </div>
        )}
        ...
        {result && result.rows.length > 0 && (
          <div style={{ marginTop:14 }}>
            <div style={{ marginBottom:8, fontSize:'0.6rem', color:'var(--txt-muted)', fontFamily:"'DM Mono',monospace", letterSpacing:'.06em' }}>
